...
═════════════════════════════════════════════════════════════════════════════
  ...
  Foundation (§ 5)           ✅ 111   archived folders (`ls openspec/archive/ | wc -l`)
  Active changes             🟡 15    4 gated engagements + 11 scaffold-only
                                       (chart-system / research-domain-entity / etc.)
  Total scope ever opened    ~126     111 archived + 15 active
═════════════════════════════════════════════════════════════════════════════
```
