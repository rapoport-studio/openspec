...
2. **Domain modeling (Mirror).** A structured discovery output covering the seven canonical steps — actors, resources, states, transactions, integrations, communications, metrics. Built collaboratively across the canvas with you, the relevant specialists, and Muse over 3–4 weeks of discovery. Lands as `openspec/mirror/<engagement-slug>/perception.md` (or as an attached artifact, depending on your repo's preference).
