...
- **AT-08 / AT-12** (RPN 12 each) are now the joint highest — meaningful surface, meaningful impact. **AT-07 dropped to RPN 4 post-mitigation** (regex scrub middleware shipped). No threat breaches the blocking threshold.
