...
| 10 | Anthropic DPA "executed" vs "not signed" contradiction | **Unchanged** | [`changes/inference-data-residency-routing-decision/design.md:12,37`](../../changes/inference-data-residency-routing-decision/design.md) treats DPA as executed (covers SCC US processing); [`changes/publish-legal-bundle/research/03-privacy-dpo.md:17`](../../changes/publish-legal-bundle/research/03-privacy-dpo.md) still names the missing DPA as "the most urgent gap". `publish-legal-bundle` is in-flight (Phase 6 only just unblocked, [#1755](https://github.com/rapoport-studio/rapoport.studio/pull/1755)) but not yet archived |
